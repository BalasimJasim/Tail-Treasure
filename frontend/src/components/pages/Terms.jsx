...
const Terms = () => {
  ...
  return (
    <div className="container">
      ...
      <p>
        We strive to accurately represent our products through descriptions and
        images. However, we do not guarantee the availability or accuracy of any
        product listed on our website.
      </p>

      <h2>4. Pricing and Payment</h2>
      <p>
        All prices are listed in Euros and are subject to change without notice.
        Payment must be made in full at the time of purchase. We accept
        Paypal,Visa Card , Master Card for online transactions
      </p>

      <h2>5. Shipping and Delivery</h2>
      <p>
        We aim to ship orders promptly, but delivery times may vary depending on
        the destination and product availability. We are not responsible for any
      ...
      <p>
        ...
        account. In the event of unauthorized access, customers should notify us
        immediately.
      </p>

      <h2>7. Privacy and Security</h2>
      <p>
        We respect the privacy of our customers and are committed to protecting
        their personal information. Any data collected during the ordering
        process will be used solely for fulfilling orders and will not be shared
      ...
      <p>
        We expect all customers to engage in respectful and lawful behavior when
        using our website and interacting with our staff. Any abusive or
      ...
      <p>
        These terms and conditions are governed by the laws of Germany, and any
        disputes arising from them shall be resolved in the courts of ????.
      </p>
      ...
      {acceptedTerms ? (
        ...
        <div className="button-container">
          <button onClick={handleAcceptTerms}>Accept Terms & Register</button>
        </div>
      )}
    </div>
  );
